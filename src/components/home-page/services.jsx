...
const services = [
  ...
  },
  {
    ...
    description:
      "We help create and distribute high-quality, SEO-friendly content for your website, including blog posts, infographics, and videos, to improve your website	&apos; s visibility and authority.",
...

  {
    name: "Local SEO",
    description:
      "We optimize your website and online presence for local search results, including optimizing your Google My Business listing, creating local citations, and building local backlinks.",
  ...
  },
  {
    name: "Technical SEO",
    description:
      "We optimize the technical aspects of your website to make it more search engine friendly, including optimizing site speed, fixing broken links, and optimizing the website	&apos;s structure.",
